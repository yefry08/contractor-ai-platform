...
export const metadata = {
  ...
  description:
    "Búsqueda y detección de anomalías en contratos públicos. Cubre 8 países: Paraguay, Colombia, Costa Rica, República Dominicana, Perú, El Salvador, Brasil, y Uruguay.",
};
